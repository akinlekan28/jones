...
<!--                    <a href="#" title="Pan Masala"><img src="--><?php //echo base_url();?><!--assets/img/flicker/img1.jpg" alt=""></a>-->
...
<!--    </div><!-- Container Ends -->
    ...
    <!-- Copyright -->
    <div id="copyright" class="back-fix">
        <div class="container">
            <div class="row">
                <div class="col-sm-4">
...
<!--                <div class="col-md-6  col-sm-6 back-fix">-->
<!--                    <ul class="nav nav-inline  justify-content-end ">-->
<!--                        <li class="nav-item">-->
